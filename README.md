...
한번의 실행으로 디도스에 많이 사용되는 중국, O**, 아** 웹***, C**P* 아이피주소 차단, 디도스 완화, 네트워크 최적화, tcpbbr (https://cloudblog.withgoogle.com/products/gcp/tcp-bbr-congestion-control-comes-to-gcp-your-internet-just-got-faster/amp/) 등을 적용해주는 프로그램(.sh) 입니다. <br><br>
